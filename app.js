...
var budgetController = (function() {
	...
	return {
		...
		deleteItem: function(type, id)
		{
			...
			if (index!==-1) //we could find element
			{
...
var UIController = (function () {
	...
	return {
		...
		displayBudget: function(obj)
		{
			...
			if (obj.percentage>0)
			{
				console.log(obj.percentage.toFixed(2));
...
var controller = (function (budgetCntrl, UICtrl) {
	...
	var ctrlAddItem=function() {
		...
		//if input is valid, do necessary stuff
	...
	var ctrlDeleteItem=function(event) {
		...
		//go 4 elements up for full HTML
		itemID=(event.target.parentNode.parentNode.parentNode.parentNode.id);

		if (itemID) //if item exists
		{
